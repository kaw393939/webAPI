            ...
            <v-card class="elevation-12" style="width: 35rem;">
              ...
              <v-card-text>
                <v-form>
                  ...
                  <v-text-field prepend-icon="lock" name="passwordConf" label="Password Confirm" type="password" :error-messages="passConfirmErrors" required @blur="$v.passConfirm.$touch()"  @input="onPassConfirmChange" ></v-text-field>
                </v-form>
              </v-card-text>
              <v-card-actions>
                <v-spacer></v-spacer>
